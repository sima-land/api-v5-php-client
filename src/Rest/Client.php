...
class Client extends BaseObject
{
     ...
     * @var string
     */
    public $baseUrl = 'https://www.sima-land.ru/api/v5';
    ...
    private $options = [
        'http_errors' => false,
        'headers' => [
            'User-Agent' => 'Sima-land api-php-client/5.0',
    ...
    public function batchQuery(array $requests)
    {
        ...
        foreach ($requests as $name => $request) {
            ...
            $promises[$name] = $client->requestAsync($request->method, $url, $this->getOptions($request));
        }
